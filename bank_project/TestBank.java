...
public class TestBank {
    ...
    public static void login() throws Exception {
        ...
        while ((line = br.readLine()) != null) {
            ...
            if (pin.equals(localpin)) {
                ...
                System.out.println("\t\t\t\t\t\t\t\t\tWelcome : " + temp[1]);
                ...
                System.out.println(color + "\t\t\t\t\t\t\t\t\t6. Delete Employe: " + reset);
                System.out.println(color + "\t\t\t\t\t\t\t\t\t7. Exit: " + reset);
                System.out.print("\n\n\t\t\t\t\t\t\t\t\tPlease Choose An Option: ");
                int ch;
                ch = s.nextInt();
                switch (ch) {
    ...
    public static void removeEmploy() throws Exception
    {
        clear();
        ...
        FileWriter fw = new FileWriter("employe2.txt");
        PrintWriter pw = new PrintWriter(fw);

        System.out.println("Plese Enter Employee Pin Number");
        Console con = System.console();
        char[] chars = con.readPassword();
        ...
        while ((line = br.readLine()) != null) {
            String temp[] = line.split("\t");
            e.pin =Integer.parseInt(temp[0]);
            e.name=temp[1];
            String date=temp[2];
            e.gender=temp[3];
            e.mobile=Long.parseLong(temp[4]);
        ...
        File oldFile = new File("employe.txt");

        oldFile.delete();

        File on = new File("employe2.txt");
        File nn = new File("employe.txt");
       ...
       while ((line = br.readLine()) != null) 
        {
            ...
            if (pin == cu.pin)
            {
                ...
                FileWriter fw2 = new FileWriter("transaction.txt", true);
                PrintWriter pw2 = new PrintWriter(fw2);

                String deposit = "deposit : " + amount;
                String updated = "Balance : " + cu.amt;
                pw2.print(cu.pin);
                pw2.print("\t");
                pw2.print(cu.deposit);
                pw2.print("\t");
                pw2.print(deposit);
                pw2.print("\t");
                pw2.print(updated);
        ...
        System.out.println("Now You Can Withdraw"+amount+"Rs  And Buy Your Dream Home!");
        System.in.read();
        withdraw();
    }
